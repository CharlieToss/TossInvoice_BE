...
public enum GlobalErrorCode implements ErrorCode{
    ...
    INVALID_KAKAO_TOKEN(HttpStatus.UNAUTHORIZED, "REQUEST_019", "유효하지 않은 카카오 액세스 토큰입니다."),
    BAD_JSON(HttpStatus.BAD_REQUEST, "REQUEST_020", "요청 형식이 잘못되었거나 JSON 구조가 유효하지 않습니다."),
    MISSING_REQUEST_HEADER(HttpStatus.BAD_REQUEST, "REQUEST_021", "필수 요청 헤더가 누락되었습니다."),
    CONSTRAINT_VIOLATION(HttpStatus.CONFLICT, "REQUEST_022", "데이터베이스 제약 조건에 위배되었습니다."),
